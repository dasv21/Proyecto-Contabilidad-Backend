...
public interface BuyBillRepository extends JpaRepository<BuyBill, Long> {
    ...
    @Query("SELECT b.id AS id, b.numBill AS numBill, b.numControl AS numControl, b.nameProvider AS nameProvider, b.rifProvider AS rifProvider, b.companyId AS companyId FROM BuyBill b")
